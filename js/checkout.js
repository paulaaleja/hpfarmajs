...
function procesarCompra(e) {
    ...
    if (compra.obtenerProductosLocalStorage().length === 0) {
        ...
        Swal.fire({
            icon:'error',
            title: 'Oops...',
            text: 'Por favor ingresar correctamente su correo',
            showConfirmButton: false,
            timer: 3000
        })
        ...
        emailjs.init('gLox-OgVe-0bGp7iV')
        ...
        .addEventListener('click', function (event) {
         ...
         cargandoGif.style.width = "100px"
            ...
            enviado.src = 'assets/img/mail-download.gif';
            enviado.style.display = 'block';
            enviado.style.width = '180px';;      
        
            const serviceID = 'default_service';
            const templateID = 'template_plrht8u';
